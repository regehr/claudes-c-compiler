...
#[test]
fn bitfield_assign_from_unsigned_char_compound_expr_must_not_sign_extend() {
    ...
    let tmp_dir = std::env::temp_dir().join(format!(
        "ccc_regress_bitfield_assign_compound_unsigned_char_{}_{}",
        std::process::id(),
        stamp
    ));
...
"#;
    ...
    assert_eq!(String::from_utf8_lossy(&run.stdout), "238 238\n");
